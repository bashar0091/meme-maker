<div class="xl:w-[500px]">
        <div id="canvasContainer" class="relative w-[100%] xl:w-[500px] h-[500px] border-[8px] border-solid border-[#48D1FF] rounded-[16px] overflow-hidden">
            <canvas id="mainCanvas" class="canvasLayer" width="500" height="500"></canvas>
        </div>

        <div class="mx-[10px] mt-4">
            <button id="resetButton" class="select-none flex justify-center items-center w-full rounded-[8px] py-4 bg-[#49D3FE] border-4 border-[#fff] cursor-pointer hover:scale-95 transition-all">
                ...
                <span class="text-center font-medium pl-4 text-[#000] text-100 text-[20px]">RESET MICHI</span>
            </button>
        </div>

        <div class="mx-[10px] mt-4">
            <button id="randomButton" class="select-none flex justify-center items-center w-full rounded-[8px] py-4 bg-[#49D3FE] border-4 border-[#fff] cursor-pointer hover:scale-95 transition-all">
                ...
                <span class="text-center font-medium pl-4 text-[#000] text-100 text-[20px]">GENERATE RANDOM</span>
            </button>
        </div>
        
        <div class="mx-[10px] mt-4">
            <button id="downloadButton" class="select-none flex justify-center items-center w-full rounded-[8px] py-4 bg-[#49D3FE] border-4 border-[#fff] cursor-pointer hover:scale-95 transition-all">
                ...
                <span class="text-center font-medium pl-4 text-[#000] text-100 text-[20px]">DOWNLOAD</span>
            </button>
        </div>
    </div>