<div class="xl:w-[500px]">
        ...
        <div class="mx-[10px] mt-4">
            <button class="select-none flex justify-center items-center w-full rounded-[8px] py-4 bg-[#49D3FE] border-4 border-[#fff] cursor-pointer hover:scale-95 transition-all">
